...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--config",
        type=str,
        default="config/sr_sr3_32_128_kface.json",
    ...
    for batch_idx, val_data in enumerate(val_loader):
        ...
        for item_idx in range(bs):
            ...
            Metrics.save_img(
                lr,
                "{}/lr/{}_{}.png".format(result_path, batch_idx, item_idx),
            )
            Metrics.save_img(
                sr,
                "{}/sr/{}_{}.png".format(result_path, batch_idx, item_idx),
            )
            Metrics.save_img(
                hr,
                "{}/hr/{}_{}.png".format(result_path, batch_idx, item_idx),
            )

...
def degrade_image(img):
    ...
    assert h == w, "Image width and height mismatch"
...
def main(args):
    ...
    global_step = 0
    if cfg.checkpoint:
        backbone.module.load_state_dict(torch.load(cfg.checkpoint))
    ...
    amp = torch.amp.grad_scaler.GradScaler(growth_interval=100)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        help="py config file",
        default="configs/multipie_from_pretrained_deg.py",
    )

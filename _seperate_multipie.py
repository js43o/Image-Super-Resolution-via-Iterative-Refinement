...
with open("multi-pie_sep_list.txt", "w") as f:
    filenames = os.listdir("/4tb/datasets/multi-pie_sep3/train/gt")
    for filename in filenames:
        gt_path = os.path.join("/4tb/datasets/multi-pie_sep3/train/gt", filename)
        sr_path = os.path.join(
            "/4tb/datasets/multi-pie_sep3/train/input", filename
        )
